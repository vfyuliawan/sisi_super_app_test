...
import 'package:sisi_super_app/router/AppRouter.dart';

void main() {
  runApp(const MyApp());
}

class SisiSupperApp extends StatelessWidget {
  const SisiSupperApp({Key? key}) : super(key: key);
